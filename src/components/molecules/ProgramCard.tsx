...
const ProgramCard: React.FC<ProgramCardProps> = ({ title, description, icon, index }) => {
    return (
        <article
            ...
            <p className={clsx('mt-8 px-6 text-gray-100', 'text-sm md:text-base lg:text-lg 2xl:text-base 3xl:text-lg')}>
                {description}
            </p>
            <div
                className={clsx(
                ...
                <Icon type={icon} className="h-10 w-20 fill-white md:h-12 md:w-24" />
            </div>
            <span
                className={clsx(
                    'absolute -bottom-16 xs:-bottom-20 sm:-bottom-16 md:-bottom-24 2xl:-bottom-20',
                    'left-2 xs:left-4 sm:left-2 lg:left-10 xl:left-16 2xl:left-3',
                    'text-5xl xs:text-6xl sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-6xl',
